...
{	 
  GPIO_InitTypeDef  GPIO_InitStructure;
	...
	//GPIO_InitStructure.GPIO_Pin = GPIO_Pin_4|GPIO_Pin_5|GPIO_Pin_6|GPIO_Pin_7;//Pa4~a7复用功能输出	
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_5|GPIO_Pin_6|GPIO_Pin_7;//Pa4~a7复用功能输出	
...
//	GPIO_PinAFConfig(GPIOA,GPIO_PinSource4,GPIO_AF_SPI1); 		//PB13复用为 SPI1
