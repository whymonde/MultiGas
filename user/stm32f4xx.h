...
#define ETH_MACFCR_PT     ((uint32_t)0xFFFF0000)  /* PauseOrStop time */
#define ETH_MACFCR_ZQPD   ((uint32_t)0x00000080)  /* Zero-quanta PauseOrStop disable */
#define ETH_MACFCR_PLT    ((uint32_t)0x00000030)  /* PauseOrStop low threshold: 4 cases */
  #define ETH_MACFCR_PLT_Minus4   ((uint32_t)0x00000000)  /* PauseOrStop time minus 4 slot times */
  #define ETH_MACFCR_PLT_Minus28  ((uint32_t)0x00000010)  /* PauseOrStop time minus 28 slot times */
  #define ETH_MACFCR_PLT_Minus144 ((uint32_t)0x00000020)  /* PauseOrStop time minus 144 slot times */
  #define ETH_MACFCR_PLT_Minus256 ((uint32_t)0x00000030)  /* PauseOrStop time minus 256 slot times */      
#define ETH_MACFCR_UPFD   ((uint32_t)0x00000008)  /* Unicast PauseOrStop frame detect */
